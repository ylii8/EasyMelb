...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top"><img src="img/icon.JPG" style="margin-right:.3rem;margin-bottom:3px;width:1.2rem;height:1.2rem;">Your Guider</a>
