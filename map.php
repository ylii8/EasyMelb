...
<script>
    ...
    document.getElementById("seatButton").addEventListener("click", function() {
        if (this.classList.contains("active")) {
            ...
            document.getElementById("seatButton").style.background= "rgba(255, 255, 255, 0.9)";
        } else{
    ...
    document.getElementById("toiletButton").addEventListener("click", function() {
        if (this.classList.contains("active")) {
            ...
            document.getElementById("toiletButton").style.background= "rgba(255, 255, 255, 0.9)";
        } else{
            this.classList.add("active");
    ...
    document.getElementById("drinkButton").addEventListener("click", function() {
        if (this.classList.contains("active")) {
            ...
            document.getElementById("drinkButton").style.background= "rgba(255, 255, 255, 0.9)";
        } else{
            this.classList.add("active");
    ...
    document.getElementById("gradientButton").addEventListener("click", function() {
        if (this.classList.contains("active")) {
            ...
            document.getElementById("gradientButton").style.background= "rgba(255, 255, 255, 0.9)";
        } else{
            this.classList.add("active");
    ...
    document.getElementById("densityButton").addEventListener("click", function() {
        if (this.classList.contains("active")) {
            ...
            document.getElementById("densityButton").style.background= "rgba(255, 255, 255, 0.9)";
        } else{
            this.classList.add("active");
    ...
    document.getElementById("3dButton").addEventListener("click", function() {
        if (this.classList.contains("active")) {
            ...
            document.getElementById("3dButton").style.background= "rgba(255, 255, 255, 0.9)";
        } else{
            this.classList.add("active");
    ...
    function checkCookie() {
        ...
        if ( expires==="" || now.getTime() > Date.parse(expires) )
        {
            intro.start();
            setCookie();
        }
