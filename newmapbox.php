...
<!--        <h2>Check out seats, toilets and drinking fountains!</h2>-->
        ...
        <div class="container_map row no-gutters" style="text-align:center">
        <!-- Filter Checkboxes -->
        ...
        <div id='menu' style="text-align: left;font-size: 18px; margin-left: 4rem;display:none;">
            ...
            <div id='hideLabel'>
                ...
                <br>
                <input id='gradient' type='radio' name='rtoggle'  >
                <label for='gradient' onclick="getGradient()">Gradient Map</label>
                <br>
